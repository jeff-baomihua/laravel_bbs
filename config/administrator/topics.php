    ...
    'columns' => [
        ...
        'title' => [
            ...
            'output'   => function ($value, $model) {
                // dd($model);
                // dd($value);
                // $s = model_admin_link(e($model->title), $model);
                // dd($s);//"<a href="http://larabbs.test/admin/topics/100" target="_blank">Animi quia adipisci est culpa.</a>"
                //$value 的数据是被过滤过的，可以安全使用
                return '<div style="max-width:260px">' . model_link($value, $model) . '</div>';
                //其他的用户数据，输出时请使用 Laravel 自带的 e() 函数对其做转义处理 如：
